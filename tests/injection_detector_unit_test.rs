...
async fn test_detect_sql_sleep_time_based() {
    ...
    assert!(result.suspicious, "SLEEP() time-based attack should be detected");
}
...
async fn test_detect_command_injection_pipe() {
    ...
    assert!(result.suspicious, "Command injection with ; should be detected");
}
...
async fn test_detect_command_injection_backticks() {
    ...
    assert!(result.suspicious, "Backtick command substitution should be detected");
}
...
async fn test_detect_path_traversal_encoded() {
    ...
    assert!(result.suspicious, "URL-encoded path traversal should be detected");
}
